<%@ Page Language="C#" AutoEventWireup="true" CodeFile="mania.aspx.cs" Inherits="mania" %>
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="mania.aspx">PIZZA MANIA</a></li>
                        </ul>
                     </li>
                ...
                <asp:Repeater ID="Repeater1" runat="server" DataSourceID="SqlDataSource1" >
                    <ItemTemplate>
                                   ...
                                   <div class="col-sm-11">
                                    ...
                                    <div><h3><%# Eval("Pname") %></h3></div>
                                        ...
                                        <div style="">
                                           ...
                                           <a style="text-decoration:none" href="login.aspx" role="button" ><h4>ORDER</h4></a>
                                           <br />
                                        </div>
                                    </div>
                                </div>
                     ...
                     <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString2 %>" SelectCommand="SELECT * FROM [pizza] WHERE ([catagory] = @catagory)">
                         <SelectParameters>
                             <asp:Parameter DefaultValue="Pizza Mania" Name="catagory" Type="String" />
                         </SelectParameters>
                     </asp:SqlDataSource>
            </div>
        </div>
